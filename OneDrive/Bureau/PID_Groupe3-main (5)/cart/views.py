...
from catalogue.models.reservation import RepresentationReservation, Reservation
...
def payment_simulation(request, reservation_id):
    ...
    return render(
        request, "cart/payment_simulation.html", {"reservation_id": reservation_id}
    )
