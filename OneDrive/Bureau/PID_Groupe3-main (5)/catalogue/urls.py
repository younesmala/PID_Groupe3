...
from .views.admin_dashboard import (AdminDashboardView, AdminUserEditView,
                                    AdminUsersView)
from .views.artist import create, delete, edit, index, show
...
urlpatterns = [
    ...
    path(
        "admin-dashboard/users/<int:pk>/edit/",
